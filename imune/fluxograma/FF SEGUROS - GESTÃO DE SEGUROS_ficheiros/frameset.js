...
var xmlData = XMLData("imunevacinas_ficheiros/data.xml");
...
{
	var strCPHTML = "";
	var strStartTable = "<table class='propViewerTABLE' borderColor='#999999' cellPadding='2' width='95%' border='1' summary='A tabela contém detalhes da forma'>";
	...
	if (shapeNode != null)
	{
		...
		{
			strCPHTML = "Não Existem Detalhes Disponíveis.";
		}
	}
