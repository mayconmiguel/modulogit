...
// validando se é inclusão, exclusão ou edição de dados.
    ...
    if($funcao == 1)
    {
        $select = "select * from centrocusto where grp_emp_id = '$grupoEmpresa' and nome = '$nome'";
        ...
        {
            $insert = "insert ignore into centrocusto(nome,naturezas,tipo,grp_emp_id)values('$nome','$naturezas','$tipo','$grupoEmpresa')";
    ...
    elseif($funcao == 2)
    {
        $update = "update ignore centrocusto set tipo = '$tipo', nome = '$nome', naturezas = '$naturezas' where id = '$id'";
    ...
    elseif($funcao == 3)
    {
        $delete = "delete from centrocusto where id = '$id'";
