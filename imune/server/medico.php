...
if($funcao == 1){
    ...
    $query = "insert ignore  into medico($campos)values($valores)";
    ...
    mysqli_set_charset($con,"utf8");
    $query = "update ignore medico set $valores where id = " . $_GET['id'];
...
elseif($funcao == 3)
{
    $delete = "delete from medico where id = '".$_POST['id']."'";
