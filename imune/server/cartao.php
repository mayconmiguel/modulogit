...
if($funcao == 1){
    ...
    $query = "insert ignore  into cartao($campos)values($valores)";
    ...
    mysqli_set_charset($con,"utf8");
    $query = "update ignore cartao set $valores where id = " . $_GET['id'];
...
elseif($funcao == 3)
{
    $delete = "delete from cartao where id = '".$_POST['id']."'";
