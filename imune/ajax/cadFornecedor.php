...
if($_cliREQUEST['type'] == 1){
	$nome = "Funcionario"; $tabela = "pessoa where produtor = 1";
}else{
	$nome = "Fornecedor"; $tabela = "pessoa where fornecedor = 1";
}
				...
				<div class="panel-group smart-accordion-default" id="accordion">
					<div class="panel panel-default">
						<div class="panel-heading">
							<h2 class="panel-title bg-color-green"><a data-toggle="collapse" href="#collapseOne"> <i class="fa fa-fw fa-plus-circle txt-color-white"></i> <i class="fa fa-fw fa-minus-circle txt-color-red"></i>  Dados Gerais</a></h2>
						</div>
						<div id="collapseOne" class="panel-collapse collapse in">
							<div class="panel-body">
								...
								<div class="row">
                                    ...
                                    <div class="col-sm-3  col-xs-12">
                                        Função<input type="text" name="cep" id="cep" class="form-control wd100">
                                    </div>
