                ...
                <div class="widget-body no-padding">
                    ...
                    <table id="datatable_fixed_column" class="table table-striped table-bordered" width="100%">
                        ...
                        <tr>
                            ...
                            <th class="hasinput">
                                <input type="text" class="form-control" placeholder="Data Aplicaçao" />
                            </th>
                            <th class="hasinput">
                        ...
                        <tr>
                            <th data-class="expand" id="id">id</th>
                            <th data-hide="phone" id="vacina">Vacina</th>
                            <th data-hide="expand" id="lote">dose</th>
                            <th data-hide="expand" id="dt_aplicacao">data aplicaçao</th>
                            <th data-hide="expand" id="dt_retorno">data retorno</th>
                            <th data-hide="expand" id="validade">validade</th>
                            <th data-hide="expand" id="unidade">unidade</th>
...
<script type="text/javascript">
    ...
    var pagefunction = function() {
        ...
        $('#novo').click(function() {
            $.post('ajax/cadcartaoVacina.php').done(function(data){
        ...
        var table = $('#datatable_fixed_column').dataTable({
            ...
            "rowCallback" : function(nRow,aData) {
                ...
                $(row).dblclick(function(){
                    loading("show");
                    $.post("ajax/cadcartaoVacina.php",{id:aData.id}).done(function(data){
                        $("#cadastro").empty().html(data);
                        $("#cadastro").dialog({
                            autoOpen : true,
                            width : '95%',
