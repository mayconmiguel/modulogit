...
<br>
    <div class="row">
        <div class="col-sm-6 col-xs-12 txt-color-greenDark">Vacinas
            <div class="icon-addon addon-sm">
                <select class="form-control txt-color-greenDark" id="vacina">
        ...
        <div class="col-lg-1 col-md-4 col-xs-12">
            Estoque<input class="form-control" id="nome" type="text">
        </div>
        <div class="col-sm-5 col-xs-12">DATA TRANSF.
            <input class="form-control" id="dt_transf" value="<?php echo date('d/m/Y');?>"/>
        </div>
        <div class="col-sm-6 col-xs-12 txt-color-greenDark">Unidade Origem
            <div class="icon-addon addon-sm">
        ...
        <div class="col-sm-6 col-xs-12 txt-color-red">Unidade. Destino
            <div class="icon-addon addon-sm">
    ...
    <div class="row">
        <div class="col-lg-3 col-md-4 col-xs-12">
            Quant a Transferir<input class="form-control" id="nome" type="text">
        </div>
        <div class="col-lg-3 col-md-4 col-xs-12">
            Estoque Final<input class="form-control" id="nome" type="text">
        </div>
        <div class="col-lg-3 col-md-4 col-xs-12">
            Estoque Unidade a Receber <input class="form-control" id="nome" type="text">
        </div>
        <div class="col-lg-3 col-md-4 col-xs-12">
            Estoque Final Unidade a Receber<input class="form-control" id="nome" type="text">
        </div>
    </div>
    <div class="col-sm-2 col-xs-12 txt-color-greenDark" style="left: 43%">Confirmar Tranferencia
        <div class="icon-addon addon-sm">
            <select class="form-control txt-color-greenDark" id="emp_destino">
                <option value="confirma">SIM</option>
                <option value="confirma">NAO</option>
...
<div class="col-xs-12 center">
    <div class="row">
        <div class="col-xs-12" style="left: 45%">
            <br><a href="javascript:void(0);" id="cadastrar" class="btn btn-sm btn-success"> <span class="btn-label"><i class="glyphicon glyphicon-floppy-disk"></i></span>TRANSFERIR</a>
        </div>
    </div>
</div>
