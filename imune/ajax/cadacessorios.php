<?php $nome = "Acessórios"; $tabela = "acessorio";?>
...
<?php
	...
	if(isset($_POST['id'])){
		...
		<script>
			...
			$.post("server/recupera.php",{tabela:'acessorio where id = <?php echo $id;?>'}).done(function(data){
			...
			$("#cancelar").click(function(){
				$.post("ajax/cadacessorios.php",{id:<?php echo $id;?>}).done(function(data){
