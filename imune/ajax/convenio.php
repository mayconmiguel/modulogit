<?php
	...
	$nome 		= "Convênio";
	$colunas	= "id,nome,desc_min,desc_max";
	$tabela		= "convenio";
								...
								<tr>
									...
									for($i=0;$i<count($explode);$i++){
										if($explode[$i] == "nome"){
											...
											<?php
										}elseif($explode[$i] == "desc_min"){
											$explode[$i] = "DESCONTO MÍNIMO"
											?>
											<th data-hide="phone">
												<?php echo strtoupper($explode[$i]);?>
											</th>
										...
										elseif($explode[$i] == "desc_max"){
											$explode[$i] = "DESCONTO MÁXIMO"
											?>
											<th data-hide="phone">
												<?php echo strtoupper($explode[$i]);?>
											</th>
								...
								while($row = mysqli_fetch_array($valida)){
									...
									<tr id="<?php echo 'tt'.$row[0];?>" style="cursor:pointer">
										<?php
											$explode = explode(",",$colunas);
											for($i=0;$i<count($explode);$i++){
												if($explode[$i] == "desc_min"){
													$row[$i] .= "%";
												}else if($explode[$i] == "desc_max"){
													$row[$i] .= "%";
												}else{
													$mask = null;
												}
