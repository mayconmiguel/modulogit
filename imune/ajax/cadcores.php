...
<?php
	...
	if(isset($_POST['id'])){
		...
		<script>
			...
			$.post("server/recupera.php",{tabela:'cor where id = <?php echo $id;?>'}).done(function(data){
			...
			$("#cancelar").click(function(){
				$.post("ajax/cadcores.php",{id:<?php echo $id;?>}).done(function(data){
