<?php
    ...
    $empresa = $_SESSION['INFINITE']['usuarioEmpresa'];
?>

<div class="jarviswidget jarviswidget" id=cadVacina">
    ...
    <div class="widget-body">
        ...
        <form action="rel/relExtratoBanco.php" method="post" target="_blank" id="rel-form" class="smart-form client-form">
            <div class="row">
                <div class="col-lg-4 col-lg-push-4 col-md-6  col-sm-8 col-xs-10" style="text-align: center">
                    <h2>RELATÓRIO - CARTA DE RETORNO</h2>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-2 col-lg-push-4 col-md-3  col-sm-4 col-sm-push-4 col-xs-5">
                ...
                <div class="col-lg-2 col-lg-push-4 col-md-3 col-sm-4 col-xs-5">
                    <label class="input">Data Final
                        <input id="to"  name="to"  style="width:98%;">
                        <b class="tooltip tooltip-top-right">Por favor, informe uma data final!</b> </label>
                </div>
            </div>
            <div class="col-lg-2 col-lg-push-4 col-md-2 col-sm-3 col-xs-6">
                <br> <a id="gerar" class="btn btn-block btn-primary" style="height: 35px; width: 99%; href="javascript:void(0);">
                <span class="btn-label">
                            <i class="glyphicon glyphicon-file"></i></span>Gerar Relatorio</a>
            </div>

            <div class="col-lg-2 col-lg-push-4 col-md-2 col-sm-3 col-xs-6">
                <br> <a id="email" class="btn btn-block btn-primary" style="height: 35px; width: 99%; href="javascript:void(0);">
                        <span class="btn-label">
                            <i class="glyphicon glyphicon-file"></i></span>Enviar Email</a>
            </div>
    </div>
    </form>
    </div>
