<?php $nome = "Configurações SMS"; $tabela = "config_sms";?>
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<label class="radio-inline">
				...
				<span title='DESPESAS' class='label label-danger text-center'>DATA COMEMORATIVA</span>
			</label>
		</div>
	</div>
	<div class="row">
			...
			$("#salvar").click(function(){
				...
				if(nome==="")
				{
					...
					$.ajax({
						...
						type: 'POST',
						cache: false,
						data: {funcao:2,id:"<?php echo $id;?>",nome:nome,tipo:tp,taxa:taxa,condicao:condicao},
						success: function(data) {
							if(data == 2){
			...
			$("#cadastrar").click(function(){
				...
				else
				{
					...
					$.ajax({
						...
						type: 'POST',
						cache: false,
						data: {funcao:1,nome:nome,taxa:taxa,tipo:tp,condicao:condicao},
						success: function(data) {
							if(data == 2){
								alerta("AVISO!","Já existe um <?php echo $nome;?> com o mesmo nome cadastrado no sistema!","warning","warning");
								focar($("#nome"));
