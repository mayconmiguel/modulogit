<?php
	...
	$tabelinha  = array("nome","data nascimento","nome da mae","nome do pai");
?>
...
<section id="widget-grid-cliente" class="well">
	...
	<div class="row" style="margin-top: 10px;">
		...
		<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div class="jarviswidget jarviswidget-color-green" id="wid-id-23" data-widget-fullscreenbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-colorbutton="false">
...
<script type="text/javascript">
	...
	var pagefunction = function() {
		...
		var table = $('#datatable_col_reorder').dataTable({
			...
			"rowCallback" : function(nRow,aData) {
				...
				$(row).dblclick(function(){
					loading("show");
					$.post("ajax/cadcliente.php",{id:aData.id}).done(function(data){
						$("#cadastro").empty().html(data);
						$("#cadastro").dialog({
							autoOpen : true,
							width : '95%',
        ...
        $("#wid-id-23").find(".dt-toolbar .localiza").append('Localizar BD:<br> <input class="form-control" id="buscaBanco">');
        $("#widget-grid-cliente").find(".dt-toolbar .dtini").append('Ret. Ini:<br> <input id="min" class="form-control">');
        $("#widget-grid-cliente").find(".dt-toolbar .dtfim").append('Ret. Fim:<br> <input class="form-control" id="max">');
