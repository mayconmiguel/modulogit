            ...
            <form action="rel/relFinanceiro.php" method="post" target="_blank" id="rel-form" class="smart-form client-form">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6  col-sm-8 col-xs-10">
                        <h2>RELATÓRIO FINANCEIRO - CENTRAL DE CONTAS</h2>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-3 col-sm-2 col-xs-1 text-align-right">
                        <input name="checkbox_pessoa" type="checkbox" style="margin-right:10px; margin-top:30px;">
                    </div>
                    <div class="col-lg-4 col-md-6  col-sm-8 col-xs-10">
                        <div class="form-group">
                            <label for="form-field-select-3">PESSOA</label>
                            <div>
                                <input class="form-control" id="pessoa" name="pessoa" disabled>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-3 col-sm-2 col-xs-1 text-align-right">
                        <input name="checkbox_empresa" type="checkbox" style="margin-right:10px; margin-top:30px;">
                    </div>
                    <div class="col-lg-4 col-md-6  col-sm-8 col-xs-10">
                        <div class="form-group">
                            <label for="form-field-select-3">EMPRESA</label>
                            <div>
                                <select class="form-control"  style="width: 100%; height: auto;" id="empresa" name="empresa[]" disabled multiple>
                                </select>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-3 col-sm-2 col-xs-1 text-align-right">
                        <input name="checkbox_banco" type="checkbox" style="margin-right:10px; margin-top:30px;">
                    </div>
                    <div class="col-lg-4 col-md-6  col-sm-8 col-xs-10">
                        <div class="form-group">
                            <label for="form-field-select-3">BANCO</label>
                            <div>
                                <select class="form-control"  style="width: 100%; height: auto;" id="banco" name="banco[]" disabled multiple>
                                </select>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-3 col-sm-2 col-xs-1 text-align-right">
                        <input name="checkbox_centrocusto" type="checkbox" style="margin-right:10px; margin-top:30px;">
                    </div>
                    <div class="col-lg-4 col-md-6  col-sm-8 col-xs-10">
                        <div class="form-group">
                            <label for="form-field-select-3">CENTRO DE CUSTO</label>
                            <div>
                                <select class="form-control"  style="width: 100%; height: auto;" id="centrocusto" name="centrocusto[]" disabled multiple>
                                </select>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-3 col-sm-2 col-xs-1 text-align-right">
                        <input name="checkbox_natureza" type="checkbox" style="margin-right:10px; margin-top:30px;">
                    </div>
                    <div class="col-lg-4 col-md-6  col-sm-8 col-xs-10">
                        <div class="form-group">
                            <label for="form-field-select-3">NATUREZA FINANCEIRA</label>
                            <div>
                                <select class="form-control"  style="width: 100%; height: auto;" id="natureza" name="natureza[]" disabled multiple>
                                </select>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-3 col-sm-2 col-xs-1 text-align-right">
                        <input name="checkbox_pagamento" type="checkbox" style="margin-right:10px; margin-top:30px;">
                    </div>
                    <div class="col-lg-4 col-md-6  col-sm-8 col-xs-10">
                        <div class="form-group">
                            <label for="form-field-select-3">FORMA DE PAGAMENTO</label>
                            <div>
                                <select class="form-control"  style="width: 100%; height: auto;" id="pagamento" name="pagamento[]" disabled multiple>
                                </select>
                            </div>
                        </div>
                    </div>
